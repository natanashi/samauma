...
function renderDemoGuide(){
  const labels=['','Publicar oportunidade','Aceitar como cooperativa','Registrar coleta no navegador','Confirmar pesagem','Executar conciliação','Validar correção','Liquidar e ratear','Reiniciar operação'];
...
function renderDemoWorkspace(){
  ...
  if(s===3){w.innerHTML=demoHeader('Executar a coleta pelo sistema web','A tarefa abre no navegador de um aparelho compartilhado da cooperativa. Celular pessoal é opcional; terminal do galpão e registro assistido continuam disponíveis.')+(r==='catador'?`<div class="phone-demo"><div class="phone-top"><b>Navegador · aparelho compartilhado</b><span class="offline-chip">offline</span></div><div class="phone-body"><div class="phone-route"><small>ROTA 07 · PARADA 2 DE 3</small><b>Mercado Ipê Roxo</b><p>Nova Porto Velho · recicláveis secos · janela até 16h</p></div><div class="phone-stats"><div><b>7,8 km</b><span>DISTÂNCIA</span></div><div><b>820 kg</b><span>ESTIMADO</span></div><div><b>R$ 96</b><span>SERVIÇO</span></div></div><label style="display:block;font-size:8px;margin-bottom:4px">MASSA OBSERVADA</label><input id="demoCollected" type="number" value="785" style="width:100%;padding:9px;margin-bottom:7px;border:1px solid #bdc8c2"><button class="phone-btn" onclick="demoRegisterCollection()">Salvar coleta no navegador</button><div class="phone-note">Sessão da rota, não vinculada ao aparelho pessoal</div></div></div>`:demoUnavailable('o responsável pela coleta ou registro assistido'));return;}
